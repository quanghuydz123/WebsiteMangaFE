...
export const MangaAdminTable: React.FC<MangaTableProps> = (
    { openModal, setCurrentSelectedManga, currentPage,
        handlePageChange,
        totalPages, rows }
) => {
                ...
                <tbody>
                    {rows.map((manga) => (
                        <tr className="border-b border-slate-200 text-sm md:text-base" key={manga._id}>
                            ...
                            <td className="px-4 py-3 font-medium">{manga.name}</td>
                            ...
                            <td className="px-4 py-3  ">
                                <button
                                    onClick={() => window.open(`/admin/Manga/${manga._id}/Chapter`, '_blank')}
